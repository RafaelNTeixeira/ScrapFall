...
var UPGRADES: Dictionary = {
	...
	"magnet_peg": {
		"label":        "Magnet Peg",
		"description":  "One peg attracts nearby balls toward it, clustering hits.",
		"cost_res":     {"Copper": 120, "Steel": 80},
		"cost_gold":    0.0,
		"placement":    true,
		"one_time":     true,
		"purchased":    false,
	...
	"sticky_peg": {
		"label":        "Sticky Peg",
		"description":  "One peg catches balls for 0.35 s then drops them straight down.",
		"cost_res":     {"Wood": 100, "Glass": 80},
		"cost_gold":    0.0,
		"placement":    true,
		"one_time":     true,
		"purchased":    false,
	...
	"relocate_magnet": {
		"label":        "Move Magnet Peg",
		"description":  "Move the Magnet peg to a new position.",
		"cost_res":     {},
		"cost_gold":    0.0,
		"placement":    true,
		"one_time":     false,
	...
	"relocate_sticky": {
		"label":        "Move Sticky Peg",
		"description":  "Move the Sticky peg to a new position.",
		"cost_res":     {},
		"cost_gold":    0.0,
		"placement":    true,
		"one_time":     false,
